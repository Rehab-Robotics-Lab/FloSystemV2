...
tmux send-keys 'sleep 5 && source ../../devel/setup.bash && rosrun flo_humanoid read_write_arms_node' Enter
tmux split-window -t motor_demo -v
tmux send-keys 'htop' Enter
tmux split-window -t motor_demo -h
tmux send-keys 'sleep 5 && python3 src/biMotorControlDemo.py' Enter
