...
tmux send-keys -t "${SESSION_NAME}:sim" "source /opt/ros/noetic/setup.zsh && source \"$WORKSPACE_SETUP\" && roslaunch flo_core full_robot_arm_sim.launch show_gz_gui:=true show_rviz_gui:=false" C-m
