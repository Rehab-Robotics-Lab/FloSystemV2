...
class SetJointPosition {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SetJointPosition(null);
  ...
  static messageDefinition() {
    ...
    return `
    #message definition to set the positon of one joint of the humanoid robot
    uint8 id
    int32 position
    `;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetJointPosition(null);
    if (msg.id !== undefined) {
      resolved.id = msg.id;
    }
    else {
...
module.exports = SetJointPosition;
