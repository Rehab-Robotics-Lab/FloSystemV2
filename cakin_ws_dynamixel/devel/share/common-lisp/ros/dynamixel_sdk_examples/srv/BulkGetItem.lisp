...
(cl:defmethod cl:initialize-instance :after ((m <BulkGetItem-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BulkGetItem-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_sdk_examples-srv:<BulkGetItem-request> is deprecated: use dynamixel_sdk_examples-srv:BulkGetItem-request instead.")))
...
(cl:defmethod item1-val ((m <BulkGetItem-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_sdk_examples-srv:item1-val is deprecated.  Use dynamixel_sdk_examples-srv:item1 instead.")
  (item1 m))

(cl:ensure-generic-function 'item2-val :lambda-list '(m))
(cl:defmethod item2-val ((m <BulkGetItem-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_sdk_examples-srv:item2-val is deprecated.  Use dynamixel_sdk_examples-srv:item2 instead.")
  (item2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BulkGetItem-request>)))
  ...
  "dynamixel_sdk_examples/BulkGetItemRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BulkGetItem-request)))
  "Returns string type for a service object of type 'BulkGetItem-request"
  "dynamixel_sdk_examples/BulkGetItemRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <BulkGetItem-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BulkGetItem-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_sdk_examples-srv:<BulkGetItem-response> is deprecated: use dynamixel_sdk_examples-srv:BulkGetItem-response instead.")))

(cl:ensure-generic-function 'value1-val :lambda-list '(m))
(cl:defmethod value1-val ((m <BulkGetItem-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_sdk_examples-srv:value1-val is deprecated.  Use dynamixel_sdk_examples-srv:value1 instead.")
  (value1 m))

(cl:ensure-generic-function 'value2-val :lambda-list '(m))
(cl:defmethod value2-val ((m <BulkGetItem-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_sdk_examples-srv:value2-val is deprecated.  Use dynamixel_sdk_examples-srv:value2 instead.")
  (value2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BulkGetItem-response>)))
  ...
  "dynamixel_sdk_examples/BulkGetItemResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BulkGetItem-response)))
  "Returns string type for a service object of type 'BulkGetItem-response"
  "dynamixel_sdk_examples/BulkGetItemResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BulkGetItem)))
  ...
  "dynamixel_sdk_examples/BulkGetItem")